...
<html>
  <head>
    <title>biocontext - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to biocontext.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>biocontext - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
